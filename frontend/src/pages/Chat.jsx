  ...
  return (
    <div className="w-full h-[calc(100vh-53px)] bg-transparent text-slate-100 flex overflow-hidden font-sans antialiased">
      ...
      <div className="flex-1 flex flex-col bg-transparent relative overflow-hidden h-full">
        ...
        <header className="px-6 py-3 bg-[#12131A]/90 backdrop-blur-md border-b border-white/10 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Statutory ground truth across GST, RBI, SEBI, MCA, and FEMA</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            {activeThreadId && messages.length > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium border border-white/10 rounded-xl bg-[#181820] hover:bg-[#20202c] hover:border-white/20 text-slate-300 hover:text-white transition-all disabled:opacity-40"
              >
                {isExporting ? (
                  <>
